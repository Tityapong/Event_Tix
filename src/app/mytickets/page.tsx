...
const MyTicketPageClient = dynamic(() => import("./my-ticket-page-client"), {
  ssr: false,
  loading: () => <MyTicketPageSkeleton />,
})
      ...
      <div className="relative container mx-auto px-4 py-8">
        <div className="mb-12 flex flex-col justify-between gap-6 sm:flex-row sm:items-center">
          ...
          <div className="flex gap-4">
            <div className="h-10 w-24 bg-gradient-to-r from-slate-200 to-slate-300 rounded-lg animate-pulse"></div>
            <div className="h-10 w-32 bg-gradient-to-r from-purple-200 to-indigo-200 rounded-lg animate-pulse"></div>
          </div>
        </div>
