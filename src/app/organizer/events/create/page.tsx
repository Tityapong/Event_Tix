...
//                             onChange={(e) => {
//                               const newTickets = [...tickets]
//                               newTickets[index].hasDiscount = e.target.checked
//                               setTickets(newTickets)
//                             }}
//                             className="h-4 w-4 rounded border-gray-300"
//                           />
//                           <Label htmlFor={`hasDiscount-${index}`}>Apply Discount</Label>
//                         </div>
//                       </div>
...
//                             max="100"
//                             placeholder="10"
//                             value={ticket.discountPercentage}
//                             onChange={(e) => {
//                               const newTickets = [...tickets]
//                               newTickets[index].discountPercentage = Number.parseInt(e.target.value)
//                               setTickets(newTickets)
//                             }}
//                             required={ticket.hasDiscount}
//                           />
//                         </div>
//                       )}
//                     </div>
...
//                           <span>${(ticket.price * (1 - ticket.discountPercentage / 100)).toFixed(2)}</span>
//                         </div>
//                       </div>
//                     )}
//                   </div>
