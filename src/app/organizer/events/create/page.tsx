...
export default function CreateEventPage() {
  ...
  const handleEventSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const eventResponse = await axios.post(`${process.env.NEXT_PUBLIC_API_URL}/events`, formData, {
        headers: {
  ...
  const handleDiscountSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (discount.discount_code && discount.discount_percentage > 0) {
        ...
        await axios.post(`${process.env.NEXT_PUBLIC_API_URL}/discounts`, discountData, {
          headers: {
            Authorization: `Bearer ${token}`,
            "Content-Type": "application/json",
          },
        ...
        <TabsContent value="details">
          <Card>
            ...
            <CardFooter className="flex justify-between">
              ...
              <Button type="button" onClick={handleEventSubmit} disabled={isSubmittingEvent}>
                {isSubmittingEvent ? "Creating Event..." : "Next: Create Ticket Type"}
              </Button>
            </CardFooter>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="ticket-types">
          <Card>
            ...
            <CardFooter className="flex justify-between">
              ...
              <Button type="button" onClick={handleTicketSubmit} disabled={isSubmittingTickets}>
                {isSubmittingTickets ? "Creating Tickets..." : "Next: Create Discount"}
              </Button>
            </CardFooter>
          </Card>
        </TabsContent>
